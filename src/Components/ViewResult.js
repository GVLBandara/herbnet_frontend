		...
		>
			<div className="w-[800px] h-[600px] bg-[#fff] rounded-[10px]">
				...
				<div className="w-[100%] h-[550px] rounded-b-[10px] flex justify-center items-center flex-col">
					...
					<div className="w-[700px] h-[70px] rounded-[5px] mt-[30px] border-solid border-[3px] border-[#dadada] flex justify-center items-start flex-col pl-[20px]">
						{
							<div key={plantData.imagePath}>
								<p>{plantData.plantData.scientificName}</p>
								<p>
									{plantData.plantData.englishName} -{' '}
									{plantData.plantData.sinhalaName}
								</p>
					...
					<div className="w-[700px] h-[50px] flex flex-row items-center mt-[10px] justify-end">
						{userIsAuthenticated() ? (
							<button
								className="w-[120px] h-[30px] rounded-[5px] bg-[#ccc] text-[#000] mr-[10px]"
								onClick={() => {
						...
						<button
							className="w-[120px] h-[30px] rounded-[5px] bg-[#ccc] text-[#000]"
							onClick={close}
						>
							Close
						</button>
